data:extend({
	{
		type = 'item',
		name = 'logistic-hive',
		icon = '__BetterBees__/graphics/icon/logistic-hive.png',
		icon_size = 32,
		subgroup = 'clean-bees',
		order = 'z',
	...
	},
	{
		...
		charging_offsets = {},
		base = {
			filename = '__BetterBees__/graphics/entity/bee-hive-idle.png',
			width = 256,
			height = 256,
		...
		base_patch = {
			filename = '__BetterBees__/graphics/nothing.png',
			priority = 'medium',
			width = 32,
			height = 32,
			frame_count = 1,
		...
		base_animation = {
			filename = '__BetterBees__/graphics/entity/bee-hive.png',
			priority = 'medium',
			width = 256,
			height = 256,
			frame_count = 4,
...
data:extend({{
	...
	type = 'technology',
	icon_size = 128,
	icon = '__BetterBees__/graphics/technology/logistic-hive.png'
}})