data:extend(
{
  --Item
  {
    type = 'item',
    name = 'hive-2',
    icon = '__BetterBees__/graphics/icon/hive-2.png',
	icon_size = 32,
  ...
  --Entity
    ...
    type = 'assembling-machine',
		name = 'hive-2',
		icon = '__BetterBees__/graphics/icon/hive-2.png',icon_size = 32,
        ...
        working_sound = {
			sound = {
				filename = '__BetterBees__/sound/bee-machine.ogg'
			},
			audible_distance_modifier = 0.5
		},
		animation=
		{
			filename = '__BetterBees__/graphics/entity/hive-2.png',
			priority = 'extra-high',
			width = 192,
			height = 192,
			frame_count = 1,
