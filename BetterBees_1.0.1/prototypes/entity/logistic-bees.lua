...
data:extend({
	{
		type = 'item',
		name = 'bee-logistic',
		icon = '__BetterBees__/graphics/icon/bee-logistic.png',
		icon_size = 32,
	...
	},
	{
		...
		max_to_charge = 0.9,
		idle = {
			filename = '__BetterBees__/graphics/entity/bee-logistic.png',
			priority = 'high',
			line_length = 2,
			width = 80,
			height = 80,
		...
		working_sound = {
			sound = {
				filename = '__BetterBees__/sound/logistic-bee.ogg'
			},
	...
	},
	{
		...
		icon = '__BetterBees__/graphics/icon/bee-construction.png',
		icon_size = 32,
	...
	},
	{
		...
		idle = {
			filename = '__BetterBees__/graphics/entity/bee-construction.png',
			priority = 'high',
			line_length = 2,
			width = 80,
			height = 80,
		...
		working_sound = {
			sound = {filename = '__BetterBees__/sound/logistic-bee.ogg'},
			audible_distance_modifier = 0.5,
			probability = 1 / (3 * 60),
