...
beekeeping.pattern['technology'] = function(species)
	...
	return {
		...
		icons = Icons:new{
			Icon:new{icon = '__BetterBees__/graphics/dynamic/bee-technology-stripes.png', icon_size = 128}:set_color(species.color):lighten(),
			Icon:new{icon = '__BetterBees__/graphics/dynamic/bee-technology-body.png', icon_size = 128}
		},
		effects = effects,
		unit = {
			count = pack_count,
...
data:extend{
	{
		type = 'technology',
		icon_size = 128,
		icon = '__BetterBees__/graphics/technology/beekeeping-1.png',
		name = 'beekeeping-1',
	...
	},
	{
		type = 'technology',
		icon_size = 128,
		icon = '__BetterBees__/graphics/technology/beekeeping-2.png',
		name = 'beekeeping-2',
