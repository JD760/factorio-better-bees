...
beekeeping.pattern['syringe'] = function(species)
	return {
		...
		icons = Icons:new{
			Icon:new{icon = '__BetterBees__/graphics/dynamic/syringe-fluid.png', icon_size = 32}:set_color(species.color),
			Icon:new{icon = '__BetterBees__/graphics/dynamic/syringe-base.png', icon_size = 32}
		},
		order = 'c',
...
beekeeping.pattern['bee'] = function(species)
	return {
		...
		icons = Icons:new{
			Icon:new{icon = '__BetterBees__/graphics/dynamic/bee-base.png', icon_size = 32},
			Icon:new{icon = '__BetterBees__/graphics/dynamic/bee-stripes.png', icon_size = 32}:set_color(species.color):lighten()
		},
		order = 'a',
...
beekeeping.pattern['larva'] = function(species)
	return {
		...
		icons = Icons:new{
			Icon:new{icon = '__BetterBees__/graphics/dynamic/larva-base.png', icon_size = 32},
			Icon:new{icon = '__BetterBees__/graphics/dynamic/larva-stripes.png', icon_size = 32}:set_color(species.color):lighten()
		},
		order = 'b',
...
beekeeping.pattern['queen'] = function(species)
	...
	for i = 1, species.queen_durability do
		prototypes[#prototypes + 1] = {
			...
			icons = Icons:new{
				Icon:new{icon = '__BetterBees__/graphics/dynamic/queen-base.png', icon_size = 32},
				Icon:new{icon = '__BetterBees__/graphics/dynamic/queen-stripes.png', icon_size = 32}:set_color(species.color):lighten()
			},
			order = 'd',
...
beekeeping.pattern['comb'] = function(species)
	return {
		...
		icons = Icons:new{
			Icon:new{icon = '__BetterBees__/graphics/dynamic/comb.png', icon_size = 32}:set_color(species.color):lighten()
		},
		order = 'e',
...
beekeeping.pattern['mold'] = function(species)
	return {
		...
		icons = Icons:new{
			Icon:new{icon = '__BetterBees__/graphics/dynamic/ore-mold-1.png', icon_size = 32}:set_color(species.color):lighten(),
			Icon:new{icon = '__BetterBees__/graphics/dynamic/ore-mold-2.png', icon_size = 32}:set_color(species.color):lighten(),
			Icon:new{icon = '__BetterBees__/graphics/dynamic/ore-mold-3.png', icon_size = 32}
		},
		order = 'f',
